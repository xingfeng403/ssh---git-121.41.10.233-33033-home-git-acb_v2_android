package com.youtu.acb.Views.ImageCycle;
...
public class ImageCycleView extends LinearLayout {
    ...
    public void setImageResources(ArrayList<BannerInfo> infoList, ImageCycleViewListener imageCycleViewListener) {
        ...
        for (int i = 0; i < imageCount; i++) {
            ...
            if (i == 0) {
                mImageViews[i].setBackgroundResource(indicators[0]);
            } else {
                mImageViews[i].setBackgroundResource(indicators[1]);
            }
    ...
    private final class GuidePageChangeListener implements OnPageChangeListener {
        ...
        public void onPageSelected(int index) {
            ...
            mImageIndex = index;
            index -= 1;
            mImageViews[index].setBackgroundResource(indicators[0]);
    ...
    private class ImageCycleAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            String imageUrl = mAdList.get(position).img_src;
